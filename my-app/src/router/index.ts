...
const routes: RouteRecordRaw[] = [
    ...
    { path: '/all-timesheet-submissions', name: 'AllTimesheetSubmissions', component: GsAllTimesheetSubmissions, meta: { requiresAuth: true } },
    { path: '/timesheet-history', name: 'TimesheetHistory', component: GsTimesheetHistory, meta: { requiresAuth: true } },
    { path: '/timesheets-to-pay', name: 'TimesheetsToPay', component: GsTimesheetsToPay, meta: { requiresAuth: true } },
]
